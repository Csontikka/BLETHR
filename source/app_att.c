...
RAM gap_periConnectParams_t my_periConnParameters = { UPDATE_CONN_PARAM };
...
static const u8 my_ModelStr[] = {DEV_MODEL_STR};
...
static const u8  my_SppName[] = {'C', 'M', 'D'};
...
attribute_t my_Attributes[] = {
	...
	{7,ATT_PERMISSIONS_READ,2,2,(u8*)(&my_primaryServiceUUID), 	(u8*)(&my_gapServiceUUID), 0},
		...
		{0,ATT_PERMISSIONS_READ,2,BLE_NAME_SIZE, (u8*)(&my_devNameUUID), (u8*)&adv_name.name, 0},
