...
void show_err_screen(s16 e) {
	// memset(&display_buff, 0, sizeof(display_buff));
	display_buff[4] &= BIT(3); // and "oo"
	display_buff[5] = 0;
	show_big_number_x10(e);
	show_temp_symbol(0xe0);
}

void show_scan_off(void) {
	// memset(&display_buff, 0, sizeof(display_buff));
	display_buff[0] = BIT(1); // "-"
...
#endif // DEVICE_TYPE == DEVICE_ZYZTH01
